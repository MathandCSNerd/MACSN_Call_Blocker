...
public class AllowedNumbersFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.allowed_numbers_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ListView numListView = activity.findViewById(R.id.white_list);
        arrayAdapter = activity.whiteListAdapter;
        numListView.setAdapter(arrayAdapter);

        view.findViewById(R.id.button_previous_allowed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(AllowedNumbersFragment.this)
                        .navigate(R.id.action_AllowedFragment_To_Previous);
            }
        });

        view.findViewById(R.id.button_next_allowed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(AllowedNumbersFragment.this)
                        .navigate(R.id.action_AllowedFragment_To_Next);
            }
        });

        numListView.setOnItemClickListener((parent, argView, position, id) -> {
            String str = parent.getItemAtPosition(position).toString();
            phoneData.removeNumberFromWhiteList(str);
